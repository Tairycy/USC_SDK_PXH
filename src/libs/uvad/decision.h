...
#define MIN_PITCH_DINGDONG1		450//-->450 //0.001538461//-->650, 0.0028571//--->350//0.002000//0.002222  ---> 500
#define MAX_PITCH_DINGDONG1      600//-->600 //0.00125//--->800//0.001176// ---> 850
#define MAX_PITCH_DINGDONG		(1.0/MIN_PITCH_DINGDONG1)//-->450 //0.001538461//-->650, 0.0028571//--->350//0.002000//0.002222  ---> 500
#define MIN_PITCH_DINGDONG      (1.0/MAX_PITCH_DINGDONG1)//-->600 //0.00125//--->800//0.001176// ---> 850

const int PATTERN_PITCH_BEGIN = 4;
#define  PATTERN_PITCH_COUNT  25
const int TOTAL_PASS_PITCH_COUNT = PATTERN_PITCH_COUNT;
const int MINI_PATTERN_PITCH_COUNT = 15;

const int PATTERN_PITCH_VALUE = 523;
const int firstPassPitch[PATTERN_PITCH_COUNT] = {

	522,522,523,522,523, 522,523,522,523,523,
	523,523,523,524,523, 524,523,524,523,524,
	523,524,523,524,524};// 523,524,523,524,523,};

const int firstPassThreshold = 180;
...
PITCH* initPITCH_USC( Int32 kHZ,Int32 nFrmMs,Int32 nSftMs,float fmaxpitch,float fminpitch);
...
int push2PITCH_full( void* handle,Int16* pWaveBuffer,Int32 nSamples,Int32 Flush , feature* features, int* pnumber,int* ave, dingEn* pdingen,int* pEnNumber,int isCheckDing);
